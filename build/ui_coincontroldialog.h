...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 MAG"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 MAG"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 MAG"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 MAG"));
