...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Magnet", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Magnet</b> version", Q_NULLPTR));
...
"Copyright \302\251 2017 The Magnet developers", Q_NULLPTR));
