...
Once these are installed, they will be found by configure and a magnet-qt executable will be
built by default.
...
# Pick some path to install BDB to, here we create a directory within the magnet directory
BDB_PREFIX="${MAGNET_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
2) The release is built with GCC and then "strip magnetd" to strip the debug
...
Security
--------
To help make your magnet installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, magnet should be built with a non-executable stack
